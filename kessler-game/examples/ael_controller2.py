...
class AEL_CompetitionController(KesslerController):
    ...
    def __init__(self):
        ...
        ship_thrust['PS'] = fuzz.trimf(ship_thrust.universe, [0, 25, 50])
        ...
        # Declare each fuzzy rule
        mc_rule1 = ctrl.Rule(collision_time['L'] & theta_delta['NL'], (ship_turn['NL'], ship_thrust['PM']))
        mc_rule2 = ctrl.Rule(collision_time['L'] & theta_delta['NM'], (ship_turn['NM'], ship_thrust['PM']))
        mc_rule3 = ctrl.Rule(collision_time['L'] & theta_delta['NS'], (ship_turn['NS'], ship_thrust['PS']))
        mc_rule5 = ctrl.Rule(collision_time['L'] & theta_delta['PS'], (ship_turn['PS'], ship_thrust['PS']))
        mc_rule6 = ctrl.Rule(collision_time['L'] & theta_delta['PM'], (ship_turn['PM'], ship_thrust['PM']))
        mc_rule7 = ctrl.Rule(collision_time['L'] & theta_delta['PL'], (ship_turn['PL'], ship_thrust['PM']))
        mc_rule8 = ctrl.Rule(collision_time['M'] & theta_delta['NL'], (ship_turn['NL'], ship_thrust['PL']))
        mc_rule9 = ctrl.Rule(collision_time['M'] & theta_delta['NM'], (ship_turn['NM'], ship_thrust['PL']))
        mc_rule10 = ctrl.Rule(collision_time['M'] & theta_delta['NS'], (ship_turn['NS'], ship_thrust['PM']))
        mc_rule12 = ctrl.Rule(collision_time['M'] & theta_delta['PS'], (ship_turn['PS'], ship_thrust['PM']))
        mc_rule13 = ctrl.Rule(collision_time['M'] & theta_delta['PM'], (ship_turn['PM'], ship_thrust['PL']))
        mc_rule14 = ctrl.Rule(collision_time['M'] & theta_delta['PL'], (ship_turn['PL'], ship_thrust['PL']))
        mc_rule15 = ctrl.Rule(collision_time['S'] & theta_delta['NL'], (ship_turn['NL'], ship_thrust['PL']))
        mc_rule16 = ctrl.Rule(collision_time['S'] & theta_delta['NM'], (ship_turn['NM'], ship_thrust['PL']))
        mc_rule17 = ctrl.Rule(collision_time['S'] & theta_delta['NS'], (ship_turn['NS'], ship_thrust['PL']))
        mc_rule19 = ctrl.Rule(collision_time['S'] & theta_delta['PS'], (ship_turn['PS'], ship_thrust['PL']))
        mc_rule20 = ctrl.Rule(collision_time['S'] & theta_delta['PM'], (ship_turn['PM'], ship_thrust['PL']))
        mc_rule21 = ctrl.Rule(collision_time['S'] & theta_delta['PL'], (ship_turn['PL'], ship_thrust['PL']))
    ...
    def actions(self, ship_state: Dict, game_state: Dict) -> Tuple[float, float, bool, bool]:
        ...
        if danger_level/2 > ship_state["fire_rate"]:
            ...
            if abs(delta_theta) > math.pi / 2:
                thrust = - moving.output['ship_thrust']
            else:
                thrust = moving.output['ship_thrust']
    ...
    @property
    def name(self) -> str:
        return "aelCompetitionController"
